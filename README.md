...
[![Testing](https://github.com/magistrala/sdk-py/actions/workflows/python-testing.yml/badge.svg?branch=main)](https://github.com/magistrala/sdk-py/actions/workflows/python-testing.yml)
[![Check SDK documentation](https://github.com/magistrala/sdk-py/actions/workflows/docs.yml/badge.svg?branch=main)](https://github.com/magistrala/sdk-py/actions/workflows/docs.yml)
...
First you need to start magistrala in your system by following the guide [here](https://github.com/magistrala/magistrala#usage)
...
Official documentation for the SDK is hosted at [here](https://github.com/magistrala/sdk-py/tree/main/docs/README.md). Documentation is auto-generated, the instructions to generate one are:

```sh
pip install lazydocs requests
python3 setup.py install
lazydocs --src-base-url="https://github.com/magistrala/sdk-py/blob/main/" --overview-file="README.md" magistrala
```
...
1. Take a look at our [open issues](https://github.com/magistrala/sdk-py/issues). The [good-first-issue](https://github.com/magistrala/sdk-py/labels/good-first-issue) label is specifically for issues that are great for getting started.
